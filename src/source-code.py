...
#add error when the id is longer than 4 characters
def registerPage():
...
def artistPage():
    ...
    Button(artistFrame, text = "add song", command=lambda: [clearFrame(artistFrame), addSong(new_song)]).grid(row=2, column=0, pady=(0,20))
